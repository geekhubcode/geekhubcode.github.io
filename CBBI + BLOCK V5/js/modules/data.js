        ...
        c = function() {
            ...
            b.prototype.getColumnDistribution = function() {
                ...
                d.forEach(function(d) {
                    ...
                    L(d, function(a, d) { "x" !== d && g.addColumnReader(a, d) });
            ...
            b.prototype.fetchLiveData = function() {
                function a(k) {
                    function f(f, h, m) {
                        function n() { c && g.liveDataURL === f && (d.liveDataTimeout = setTimeout(a, l)) }
                        if (!f || !/^(http|\/|\.\/|\.\.\/)/.test(f)) return f && e.error && e.error("Invalid URL"), !1;
                        ...
                        r({
                            ...
                            error: function(a, d) { 3 > ++b && n(); return e.error && e.error(d, a) }
                        });
                        return !0
                    }
            ...
            b.prototype.getFreeIndexes = function(a, d) {
                ...
                for (a = 0; a < d.length; a += 1) { var h = d[a].getReferencedColumnIndexes(); for (b = 0; b < h.length; b += 1) e[h[b]] = !1 }
